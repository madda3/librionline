 ...
 * @author Zilfio
 */
public class VisualizzaCopieElettroniche extends HttpServlet {

    private List analizza_form_ricerca_titolo_libro(HttpServletRequest request, HttpServletResponse response) {
        
        String titolo = request.getParameter("ricerca_libro_titolo4");
        ...
        if(session != null){
            ...
            if(dl.isAdmin((String)session.getAttribute("username"))){
                ...
                if(search_title == null){
                    ...
                    res.activate("backoffice_ricercalibro4.ftl.html", request, response);
                }
                else{
                    List<Libro> libri = analizza_form_ricerca_titolo_libro(request,response);
                        ...
                        res.activate("backoffice_risultatiricercalibri4.ftl.html", request, response);     
                }
            }
            else{
