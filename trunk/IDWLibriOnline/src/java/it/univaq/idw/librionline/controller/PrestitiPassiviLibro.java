 ...
 * @author Zilfio
 */
public class PrestitiPassiviLibro extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(session != null){
            ...
            if(dl.isAdmin((String)session.getAttribute("username"))){
                ...
                List<Prestito> ppl = dl.prestitiPassiviLibro(isbn);

                if(ppl.isEmpty()){
                    request.setAttribute("prestitipassivi",null);
                }
                else{
                    request.setAttribute("prestitipassivi",ppl);
                }
